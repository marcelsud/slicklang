...
func nativeSymbol(operation runtimeOperationID) string {
	implementation, ok := llvmRuntimeOperations[operation]
	if !ok || implementation.entry == "core" || implementation.entry == "generated-json" {
		return ""
	}
